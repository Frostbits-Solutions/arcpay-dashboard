...
export const services: Record<string, NetworkServices> = {
  'voi:testnet': {
    ...
    getExplorerLink: (objectId: string) => voi.getExplorerLink('voi:testnet', objectId),
  },
  'voi:mainnet': {
    ...
    getExplorerLink: (objectId: string) => voi.getExplorerLink('voi:mainnet', objectId),
  },
  'algo:testnet': {
    ...
    getExplorerLink: (objectId: string) => algo.getExplorerLink('algo:testnet', objectId),
  },
  'algo:mainnet': {
    getAddressAssets: (algodClient: algosdk.Algodv2, address: string, page?: number, size?: number) => algo.getAddressAssets(algodClient, address, page, size),
    getCreatedAppId: (algodClient: algosdk.Algodv2, txId: string) => algo.getCreatedAppId(algodClient, txId, 'algo:mainnet'),
    getExplorerLink: (objectId: string) => algo.getExplorerLink('algo:mainnet', objectId),
  },
}
