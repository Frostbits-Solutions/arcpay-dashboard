...
<template>
  <nav class="bg-white dark:bg-gray-900 flex flex-wrap items-center justify-between fixed w-full z-20 top-0 left-O pl-20 py-4 pr-4 border-b border-gray-200 dark:border-gray-600 box-border">
