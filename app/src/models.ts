...
export type AccountChainParameter = Database['public']['Tables']['accounts_chains_parameters']['Row']
...
export type SubscriptionChainParameters = Database['public']['Tables']['subscriptions_chains_parameters']['Row']
