...
CREATE OR REPLACE FUNCTION "public"."get_listing_by_id"("listing_id" "uuid") RETURNS "public"."composite_listing"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    AS $function$
        select l.id, l.created_at, l.updated_at, l.status, l.chain, l.seller_address, l.listing_name, l.listing_currency, l.listing_type, l.app_id, l.asset_id, l.asset_thumbnail, l.asset_type, l.asset_qty, l.asset_creator, l.tags, a.min_price, a.max_price, a.increment, a.duration, a.type as auctions_type, s.asking_price
