...
<template>
  <DialogPortal>
    <DialogOverlay class="bg-muted/50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 backdrop-blur-md" />
    <DialogContent
      v-bind="forwarded"
      :class="
        cn(
