...
import { AreaChart } from '@repo/ui/chart-area'
...
<template>
  <div class="w-full max-w-xs rounded-lg border border-border p-6">
    <div class="flex justify-between">
      <div>
        <h5 class="text-3xl font-bold leading-none text-foreground">
